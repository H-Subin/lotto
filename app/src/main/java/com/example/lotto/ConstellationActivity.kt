...
class ConstellationActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnGoResultConstell = findViewById<Button>(R.id.btnGo_Const)

        val datePicker = findViewById<DatePicker>(R.id.dataPicker)
        val txtConstell = findViewById<TextView>(R.id.textView_constell)
        val calendar = Calendar.getInstance()

        txtConstell.text = makeConstellationString(datePicker.month, datePicker.dayOfMonth)
        datePicker.init(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH), object : CalendarView.OnDateChangeListener,
        ...
        btnGoResultConstell.setOnClickListener{
            ...
            intent.putExtra("comste;;ation", makeConstellationString(datePicker.month, datePicker.dayOfMonth))
